...
public class MeteoPodaci {
    ...
    public String toString() {
        return "MeteoPodaci{" + "sunRise=" + sunRise + ", sunSet=" + sunSet + ", temperatureValue=" + temperatureValue + ", temperatureMin=" + temperatureMin + ", temperatureMax=" + temperatureMax + ", temperatureUnit=" + temperatureUnit + ", humidityValue=" + humidityValue + ", humidityUnit=" + humidityUnit + ", pressureValue=" + pressureValue + ", pressureUnit=" + pressureUnit + ", windSpeedValue=" + windSpeedValue + ", windSpeedName=" + windSpeedName + ", windDirectionValue=" + windDirectionValue + ", windDirectionCode=" + windDirectionCode + ", windDirectionName=" + windDirectionName + ", cloudsValue=" + cloudsValue + ", cloudsName=" + cloudsName + ", visibility=" + visibility + ", precipitationValue=" + precipitationValue + ", precipitationMode=" + precipitationMode + ", precipitationUnit=" + precipitationUnit + ", weatherNumber=" + weatherNumber + ", weatherValue=" + weatherValue + ", weatherIcon=" + weatherIcon + ", lastUpdate=" + lastUpdate + '}';
    }
